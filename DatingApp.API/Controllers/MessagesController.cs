    ...
    public class MessagesController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetMessage(int userId, int id)
        {
            ...
            if( messageFromRepo == null)
                return NotFound(messageFromRepo);
        ...
        public async Task<IActionResult> CreateMessage(int userId, MessageForCreationDto messageForCreationDto)
        {
            ...
            if(userId == messageForCreationDto.RecipientId)
                return BadRequest("Not possible send message to yourself");
            ...
            if(await _repo.SaveAll()){
                var messageComplete = await _repo.GetMessage(message.Id);  
                var messageToReturn = _mapper.Map<MessageToReturnDto>(messageComplete);
                return CreatedAtRoute("GetMessage", new {userId, id=message.Id}, messageToReturn);         
            }

            throw new Exception("Adding message fail on server");   
        }
        ...
        public async Task<IActionResult> MarkMessageAsRead(int id, int userid)
        {
            ...
            throw new Exception("Failed set read to message");       
        }
    }
}